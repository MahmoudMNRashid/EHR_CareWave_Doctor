...
import classes from './ModalForAddXray.module.css'
...
const ModalAdd = (props) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if(data.data.message==='X_ray added'){
    ...
    const configurationName = { type: 'text', label: 'اسم الصورة' }
    return (
...
export const ModalForAddXray = (props) => {
